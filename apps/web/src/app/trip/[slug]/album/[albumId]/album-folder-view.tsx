...
function AboutWorldMark() {
  return (
    <svg
      ...
      viewBox="0 0 200 200"
    >
      <circle cx="100" cy="100" r="72" stroke="currentColor" strokeWidth="1.4" />
      <ellipse
        cx="100"
        cy="100"
        rx="28"
      ...
      />
      <path
        d="M28 100h144M42 64h116M42 136h116"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="1.1"
      />
      <path
        d="M38 128c38-52 86-58 128-18"
        stroke="currentColor"
        strokeDasharray="4 5"
        strokeLinecap="round"
        strokeWidth="1.4"
      />
      <path
        d="M154 86 166 82l12-10 3 8 12 5-12 3-2 12-8-9-12 5Z"
        fill="currentColor"
      />
    </svg>
  );
